var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)clubhouse\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)dangeek\.nz$/.test(host)) return "+proxy";
        if (/(?:^|\.)debank\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)data\.gov\.sg$/.test(host)) return "+proxy";
        if (/(?:^|\.)moh\.gov\.sg$/.test(host)) return "+proxy";
        if (/(?:^|\.)nytimes\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hackernoon\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jayconrod\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)defikingdoms\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)eprice\.com\.hk$/.test(host)) return "+proxy";
        if (/(?:^|\.)yingmang\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)chuan\.us$/.test(host)) return "+proxy";
        if (/(?:^|\.)jrkan\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)zks\.app$/.test(host)) return "+proxy";
        if (/(?:^|\.)zks\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)hatenablog\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)go\.dev$/.test(host)) return "+proxy";
        if (/(?:^|\.)deployonfriday\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)levels\.fyi$/.test(host)) return "+proxy";
        if (/(?:^|\.)github-releases\.githubusercontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dydx\.exchange$/.test(host)) return "+proxy";
        if (/(?:^|\.)1lib\.limited$/.test(host)) return "+proxy";
        if (/(?:^|\.)dankradfeist\.de$/.test(host)) return "+proxy";
        if (/(?:^|\.)medium\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)rainfinance\.one$/.test(host)) return "+proxy";
        if (/(?:^|\.)intercom\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gitbook\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)github\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)coinlist\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)instagram\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)clubhousedb\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)defillama\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sommelier\.finance$/.test(host)) return "+proxy";
        if (/(?:^|\.)terra\.money$/.test(host)) return "+proxy";
        if (/(?:^|\.)hkbu\.edu\.hk$/.test(host)) return "+proxy";
        if (/(?:^|\.)curve\.fi$/.test(host)) return "+proxy";
        if (/(?:^|\.)bancor\.network$/.test(host)) return "+proxy";
        if (/(?:^|\.)aave\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)crazy\.one$/.test(host)) return "+proxy";
        if (/(?:^|\.)dune\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)bscscan\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sportsteam365\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)paradigm\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)weibo\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)maven\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bbc\.in$/.test(host)) return "+proxy";
        if (/(?:^|\.)jrskan\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gitcoin\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)usa-phone-number\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)excalidraw\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)programmersought\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)firebird\.finance$/.test(host)) return "+proxy";
        if (/(?:^|\.)z-lib\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)2lib\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)gist\.githubusercontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lootswap\.finance$/.test(host)) return "+proxy";
        if (/(?:^|\.)mikefrancis\.dev$/.test(host)) return "+proxy";
        if (/(?:^|\.)ericelliottjs\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)newdex\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)baidu\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)openswap\.one$/.test(host)) return "+proxy";
        if (/(?:^|\.)dev\.to$/.test(host)) return "+proxy";
        if (/(?:^|\.)golang\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)joshwcomeau\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sportsteam333\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)messari\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)twitter\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tripetto\.app$/.test(host)) return "+proxy";
        if (/(?:^|\.)nuc\.edu\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)sjk\.space$/.test(host)) return "+proxy";
        if (/(?:^|\.)solana\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ethswarm\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)slock\.it$/.test(host)) return "+proxy";
        if (/(?:^|\.)clb\.org\.hk$/.test(host)) return "+proxy";
        if (/(?:^|\.)cryptofees\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)uniswap\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)v2ex\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)signal\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)capital\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mochiswap\.io$/.test(host)) return "DIRECT";
        if (/(?:^|\.)cryptographyengineering\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ft\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)everipedia\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)hackmd\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)plasmnet\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)techcrunch\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)ethereum\.org$/.test(host)) return "DIRECT";
        if (/(?:^|\.)audius\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)balancer\.exchange$/.test(host)) return "+proxy";
        if (/(?:^|\.)chn\.lk$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)joanielemercier\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ankr\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)snapshot\.page$/.test(host)) return "+proxy";
        if (/(?:^|\.)mirror\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)amzn\.to$/.test(host)) return "+proxy";
        if (/(?:^|\.)towardsblockchain\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)google-analytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)twimg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mixbytes\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)casperlabs\.io$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)near\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)clubhouse\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)openzeppelin\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jsfiddle\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)nakabonne\.dev$/.test(host)) return "+proxy";
        if (/(?:^|\.)udemy\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)basicattentiontoken\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)brave\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)consenlabs\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gasnow\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)bquh\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)tcrn\.ch$/.test(host)) return "+proxy";
        if (/(?:^|\.)threader\.app$/.test(host)) return "+proxy";
        if (/(?:^|\.)kyber\.network$/.test(host)) return "+proxy";
        if (/(?:^|\.)0xtracker\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xuite\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)golangweekly\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)blits\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)bit\.ly$/.test(host)) return "+proxy";
        if (/(?:^|\.)fave\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)mattward\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)speakerdeck\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ndtv\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)smartdraw\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)coinmarketcap\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)archive\.is$/.test(host)) return "+proxy";
        if (/(?:^|\.)tenderly\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)listennotes\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ethfiddle\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lma-art-gallery\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloudwafer\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)s3\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)imindmap\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)glassnode\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)substack\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)duneanalytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)iterationsyndicate\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)seeswap\.one$/.test(host)) return "+proxy";
        if (/(?:^|\.)crosschain\.loans$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)buff\.ly$/.test(host)) return "+proxy";
        if (/(?:^|\.)swoop\.exchange$/.test(host)) return "+proxy";
        if (/(?:^|\.)hmy\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)amazonwas\.com$/.test(host)) return "+proxy";
    ...
    "+proxy": function(url, host, scheme) {
        ...
        switch (scheme) {
          case "http":
            return "SOCKS5 127.0.0.1:3080; SOCKS 127.0.0.1:3080";
